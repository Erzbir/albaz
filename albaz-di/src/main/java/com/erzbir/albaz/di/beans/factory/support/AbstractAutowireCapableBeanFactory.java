package com.erzbir.albaz.di.beans.factory.support;


import com.erzbir.albaz.di.beans.aware.Aware;
import com.erzbir.albaz.di.beans.aware.BeanClassLoaderAware;
import com.erzbir.albaz.di.beans.aware.BeanFactoryAware;
import com.erzbir.albaz.di.beans.aware.BeanNameAware;
import com.erzbir.albaz.di.beans.factory.AutowireCapableBeanFactory;
import com.erzbir.albaz.di.beans.instance.InstantiationService;
import com.erzbir.albaz.di.beans.instance.support.JdkInstantiationServiceSupport;
import com.erzbir.albaz.di.beans.po.BeanDefinition;
import com.erzbir.albaz.di.beans.po.BeanReference;
import com.erzbir.albaz.di.beans.po.PropertyValue;
import com.erzbir.albaz.di.beans.processor.BeanPostProcessor;
import com.erzbir.albaz.di.beans.processor.InstantiationAwareBeanPostProcessor;
import com.erzbir.albaz.di.beans.sessions.PropertyValueSession;
import com.erzbir.albaz.di.context.DisposableBean;
import com.erzbir.albaz.di.context.InitializingBean;
import com.erzbir.albaz.di.context.suppport.DisposableBeanAdapter;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    private InstantiationService instantiationService = new JdkInstantiationServiceSupport();

    // private InstantiationService instantiationService = new CglibInstantiationServiceSupport ();
    @Override
    ...
    protected void populateBean(String name, Object bean, BeanDefinition beanDefinition) {
        //处理注解对属性的赋值
        ...
        //为实现了DisposableBean接口/配置了destroy-name的Bean对象添加销毁方法
