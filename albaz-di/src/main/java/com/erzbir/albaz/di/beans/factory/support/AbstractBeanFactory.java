...
import com.erzbir.albaz.di.beans.factory.FactoryBean;
import com.erzbir.albaz.di.beans.po.BeanDefinition;
import com.erzbir.albaz.di.beans.processor.BeanPostProcessor;
import com.erzbir.albaz.di.beans.registry.support.FactoryBeanRegistrySupport;
...
public abstract class AbstractBeanFactory extends FactoryBeanRegistrySupport implements ConfigurableListableBeanFactory {
     ...
     * 类加载器
     */
    private final ClassLoader beanClassLoader = ProxyUtils.getDefaultClassLoader();
